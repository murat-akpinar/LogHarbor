...
// The entrance sweep that used to live here (SWEEP_MS and sweep()) is gone with the rest of the
// chart motion: bars are drawn, not grown. See the motion block in index.css for why.
